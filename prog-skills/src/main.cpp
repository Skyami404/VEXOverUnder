...
void autonomous(void) {
  ...
  pid_turn_by(-62, 1000); // -68 // position to go to middle to push triballs //-60
  //wing2_move();
  pid_drive(-23, 1500, 0, 30); //-27
  pid_turn_by(140, 1000);
